...
public class MainActivity extends AppCompatActivity {
    ...
    public void play(View v){
        ...
        if (userText != null && userText.length() > 0){
            ...
            TextView lblNumOfGuessLeft = findViewById(R.id.lblNumOfGuessesLeft);
            lblNumOfGuessLeft.setText("" + hangman.getGuessesLeft());

            FragmentManager fragmentManager = getSupportFragmentManager();
            GameStateFragment gameStateFragment = (GameStateFragment)fragmentManager.findFragmentById((R.id.layoutGameState));
            ...
            if (result != 0){
                GameResultFragment gameResultFragment = (GameResultFragment)fragmentManager.findFragmentById(R.id.layoutGameResult);
                if (result == 1){
            ...
            if(hangman.getGuessesLeft() == 1){
                Log.i("MainActivity", "ONLY 1 LEFT");
                BackgroundFragment backgroundFragment = (BackgroundFragment)fragmentManager.findFragmentByTag("background");
                GameResultFragment gameResultFragment = (GameResultFragment)fragmentManager.findFragmentById(R.id.layoutGameResult);
